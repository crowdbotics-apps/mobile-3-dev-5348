export const installed_blueprints = [
  //@BlueprintInsertion
{ name: 'EmailAuth5005', human_name: 'Email Auth', access_route: 'EmailAuth5005', icon: 'envelope-o'},
{ name: 'EmailAuth5001', human_name: 'Email Auth', access_route: 'EmailAuth5001', icon: 'envelope-o'},
